package com.young.weexbase.weex.dialog;
...
public class ConfirmDialog {
    ...
    private void initView() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(context,
                ...
                .setPositiveButton(confirmStr == null ? context.getString(R.string.string_confirm) : confirmStr, new DialogInterface.OnClickListener() {
                    @Override
        ...
        if(isCancel||cancelStr!=null) {
            builder.setNegativeButton(cancelStr == null ? context.getString(R.string.string_cancel) : cancelStr, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    if(clickListener!=null){
                        clickListener.onClick(dialog,-1);
