 ...
 */
package com.young.weexbase.weex.view;
...
public class WeexImageView extends GifImageView implements WXGestureObservable,
        IRenderStatus<WeexImage> {

  private WeakReference<WeexImage> mWeakReference;
  ...
  public void setImageDrawable(@Nullable Drawable drawable, boolean isGif) {
    ...
    if ((layoutParams = getLayoutParams()) != null) {
      ...
      //Glide.with(getContext()).asGif().load(wrapDrawable).into(this);
      super.setImageDrawable(wrapDrawable);
      if (mWeakReference != null) {
        WeexImage component = mWeakReference.get();
        if (component != null) {
  ...
  @Override
  public void holdComponent(WeexImage component) {
